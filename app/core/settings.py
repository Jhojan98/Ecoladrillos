...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # JWT añadido
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Por ahora sin restricciones
    ],
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt',  # JWT añadido
]
