    ...
    var setMetaData = function setMetaData2() {
      ...
      var sx = function sx2() {
        ...
        if (when) {
          ...
          var base = _getOptionValue(inlineStyles3, key, _objectSpread({
            props: props2,
            state
          }, params));
...
var Tooltip = React5.memo(React5.forwardRef(function(inProps, ref) {
  ...
  var createElement11 = function createElement12() {
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react4.default.createElement(Transition_default, _extends5({}, props, {
...
CSSTransition.propTypes = true ? _extends5({}, Transition_default.propTypes, {
  /**
  ...
  _proto.handleExited = function handleExited(child, node) {
    ...
    if (this.mounted) {
      this.setState(function(state) {
        var children2 = _extends5({}, state.children);
...
var TimesIcon = React14.memo(React14.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var WindowMaximizeIcon = React15.memo(React15.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React15.createElement("svg", _extends7({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var WindowMinimizeIcon = React16.memo(React16.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var FocusTrap = import_react9.default.memo(import_react9.default.forwardRef(function(inProps, ref) {
  var targetRef = import_react9.default.useRef(null);
  var firstFocusableElementRef = import_react9.default.useRef(null);
  var lastFocusableElementRef = import_react9.default.useRef(null);
  var context = import_react9.default.useContext(PrimeReactContext);
  ...
  import_react9.default.useImperativeHandle(ref, function() {
    return {
      props,
      getInk: function getInk() {
  ...
  var createHiddenFocusableElements = function createHiddenFocusableElements2() {
    ...
    return import_react9.default.createElement(import_react9.default.Fragment, null, firstFocusableElement, props.children, lastFocusableElement);
  };
...
var Dialog = React17.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  ...
  var _React$useState = React17.useState(uniqueId), _React$useState2 = _slicedToArray5(_React$useState, 2), idState = _React$useState2[0];
  _React$useState2[1];
  var _React$useState3 = React17.useState(false), _React$useState4 = _slicedToArray5(_React$useState3, 2), maskVisibleState = _React$useState4[0], setMaskVisibleState = _React$useState4[1];
  var _React$useState5 = React17.useState(false), _React$useState6 = _slicedToArray5(_React$useState5, 2), visibleState = _React$useState6[0], setVisibleState = _React$useState6[1];
  var _React$useState7 = React17.useState(props.maximized), _React$useState8 = _slicedToArray5(_React$useState7, 2), maximizedState = _React$useState8[0], setMaximizedState = _React$useState8[1];
  var dialogRef = React17.useRef(null);
  var maskRef = React17.useRef(null);
  var pointerRef = React17.useRef(null);
  var contentRef = React17.useRef(null);
  var headerRef = React17.useRef(null);
  var footerRef = React17.useRef(null);
  var closeRef = React17.useRef(null);
  var dragging = React17.useRef(false);
  var resizing = React17.useRef(false);
  var lastPageX = React17.useRef(null);
  var lastPageY = React17.useRef(null);
  var styleElement = React17.useRef(null);
  var attributeSelector = React17.useRef(uniqueId);
  var focusElementOnHide = React17.useRef(null);
  ...
  var _DialogBase$setMetaDa = DialogBase.setMetaData(_objectSpread6(_objectSpread6({
    props
  }, props.__parentMetadata), {}, {
    state: {
      id: idState,
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (props.closable && props.showCloseIcon) {
      ...
      var icon2 = props.closeIcon || React17.createElement(TimesIcon, closeButtonIconProps);
      var headerCloseIcon = IconUtils.getJSXIcon(icon2, _objectSpread6({}, closeButtonIconProps), {
        props
      });
      ...
      return React17.createElement("button", closeButtonProps, headerCloseIcon, React17.createElement(Ripple, null));
    }
    return null;
  };
  var createMaximizeIcon = function createMaximizeIcon2() {
    ...
    if (!maximized) {
      icon2 = props.maximizeIcon || React17.createElement(WindowMaximizeIcon, maximizableIconProps);
    } else {
      icon2 = props.minimizeIcon || React17.createElement(WindowMinimizeIcon, maximizableIconProps);
    }
    ...
    if (props.maximizable) {
      ...
      return React17.createElement("button", maximizableButtonProps, toggleIcon, React17.createElement(Ripple, null));
    }
    return null;
  };
  var createHeader = function createHeader2() {
    if (props.showHeader) {
      ...
      return React17.createElement("div", headerProps, React17.createElement("div", headerTitleProps, header2), React17.createElement("div", headerIconsProps, icons, maximizeIcon, closeIcon));
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React17.createElement("div", contentProps, props.children);
  };
  var createFooter = function createFooter2() {
    ...
    return footer2 && React17.createElement("div", footerProps, footer2);
  };
  ...
  var createElement11 = function createElement12() {
    ...
    return React17.createElement(React17.Fragment, null, header2, content2, footer2, resizer);
  };
  var createDialog = function createDialog2() {
    ...
    if (inProps !== null && inProps !== void 0 && inProps.content) {
      ...
      contentElement = createElement11();
    }
    var rootElement = React17.createElement("div", maskProps, React17.createElement(CSSTransition2, _extends9({
      nodeRef: dialogRef
    }, transitionProps), React17.createElement("div", rootProps, React17.createElement(FocusTrap$1, {
      autoFocus: props.focusOnShow
    }, contentElement))));
    return React17.createElement(Portal, {
      element: rootElement,
      appendTo: props.appendTo,
      visible: true
    });
...
var confirmDialog = function confirmDialog2() {
  var props = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  props = _objectSpread7(_objectSpread7({}, props), {
  ...
  var show = function show2() {
    ...
    OverlayService.emit("confirm-dialog", _objectSpread7(_objectSpread7(_objectSpread7({}, props), updatedProps), {
      visible: true
    }));
  };
...
var ConfirmDialog = React18.memo(React18.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  var props = ConfirmDialogBase.getProps(inProps, context);
  var _React$useState = React18.useState(props.visible), _React$useState2 = _slicedToArray6(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = React18.useState(false), _React$useState4 = _slicedToArray6(_React$useState3, 2), reshowState = _React$useState4[0], setReshowState = _React$useState4[1];
  var confirmProps = React18.useRef(null);
  var isCallbackExecuting = React18.useRef(false);
  var focusElementOnHide = React18.useRef(null);
  ...
  var createFooter = function createFooter2() {
    ...
    var content2 = React18.createElement(React18.Fragment, null, React18.createElement(Button, rejectButtonProps), React18.createElement(Button, acceptButtonProps));
  ...
  var createElement11 = function createElement12() {
    ...
    var icon2 = IconUtils.getJSXIcon(getPropValue("icon"), _objectSpread7({}, iconProps), {
      props: currentProps
    });
    var footer2 = createFooter();
    ...
    return React18.createElement(Dialog, _extends10({}, rootProps, {
      content: inProps === null || inProps === void 0 ? void 0 : inProps.content
    }), icon2, React18.createElement("span", messageProps, message));
  };
  var element = createElement11();
